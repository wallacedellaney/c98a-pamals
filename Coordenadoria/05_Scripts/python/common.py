"""Caminhos e utilidades compartilhadas pelos scripts de extração/tratamento da Coordenadoria."""
...
def registrar_log(nome_execucao, arquivos_lidos, arquivos_gerados, inconsistencias, erros=None, proximas_acoes=None):
    """Grava um log de execução em 06_Logs/, no mesmo formato do Contrato 005."""
