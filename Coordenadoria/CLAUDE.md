...
* **Motores** (2026-07-14) — situação de motores (SILOMS) e hélices, projeção de TBO/HSI (com os comentários de célula da Diagonal Nova, mostrada também na Diagonal de Manutenção) e ordens de serviço em andamento, a partir da planilha pessoal do Wallace "MOTORES C-98". Compartilhada com a conta de serviço em 2026-07-15 — entrou na automação de 2 em 2h. Ver `00_Instrucoes/motores.md`.
